...
# Whole-app login gate. Leave blank to keep login disabled.
...
API_FLAGS=(
  ...
  --set-env-vars SHOPIFY_SHOP_DOMAIN="$SHOPIFY_SHOP_DOMAIN",SHOPIFY_PUBLIC_DOMAIN="$SHOPIFY_PUBLIC_DOMAIN",SHOPIFY_API_VERSION="$SHOPIFY_API_VERSION",META_AD_ACCOUNT_ID="$META_AD_ACCOUNT_ID",META_PAGE_ID="$META_PAGE_ID",META_API_VERSION="$META_API_VERSION",CELERY_BROKER_URL="$CELERY_BROKER_URL",CELERY_RESULT_BACKEND="$CELERY_RESULT_BACKEND",CHATKIT_WORKFLOW_ID="$CHATKIT_WORKFLOW_ID",CHATKIT_WORKFLOW_VERSION="$CHATKIT_WORKFLOW_VERSION",OPENAI_IMAGE_MODEL="$OPENAI_IMAGE_MODEL",OPENAI_IMAGE_QUALITY="$OPENAI_IMAGE_QUALITY",OPENAI_IMAGE_SIZE="$OPENAI_IMAGE_SIZE",PRODUCT_TESTING_USERNAME="$PRODUCT_TESTING_USERNAME",PRODUCT_TESTING_PASSWORD="$PRODUCT_TESTING_PASSWORD",PRODUCT_TESTING_AUTH_SECRET="$PRODUCT_TESTING_AUTH_SECRET"
