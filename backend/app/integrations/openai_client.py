...
def gen_clean_wholesale_product_image_openai(image_url: str) -> str | None:
    ...
    with tempfile.NamedTemporaryFile(suffix=ext) as fh:
        ...
        prompt = (
            ...
            "Do not:\n"
            "Do not create a lifestyle scene. Do not add models, hands, props, labels, badges, extra text other than the subtle repeated EasyGros watermark, packaging, extra products, invented variants, duplicated variants, or changed colors. Do not choose only one variant. Do not merge variants together. Do not restyle the product. Do not place watermark text on top of any product or product shadow.\n\n"
            "Output:\n"
