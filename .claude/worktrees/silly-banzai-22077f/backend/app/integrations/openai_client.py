...
def gen_clean_wholesale_product_image_openai(image_url: str) -> str | None:
    ...
    with tempfile.NamedTemporaryFile(suffix=ext) as fh:
        ...
        prompt = (
            ...
            "Preserve:\n"
            "Preserve the exact product identity, silhouette, geometry, proportions, materials, colors, stitching, texture, decorations, soles, straps, closures, and functional details for every variant. Keep any text, logo, size mark, brand mark, printed graphic, embossed mark, stitched label, or molded lettering that is physically part of the actual product surface, such as markings on sandals, shoes, soles, straps, tongues, insoles, fabric, or packaging-integrated product pieces. These on-product details must remain natural, legible when visible in the source, and attached to the same product area. The generated image must still look like the same real products from the vendor photo.\n\n"
            "Clean up:\n"
            "Remove the original background, clutter, table surfaces, hands, people, packaging distractions, loose price tags, removable size stickers, handwritten marks, QR codes, barcodes, watermarks, store names, off-product brand names, off-product logos, and any numbers or text that are not physically printed, embossed, stitched, molded, or attached on the actual product itself.\n\n"
            "Watermark:\n"
            "Add a repeated, clean, semi-transparent \"EasyGros\" watermark only in the empty white or very light background areas. Keep every watermark fully off the products. Do not place any watermark over product surfaces, edges, shadows, straps, soles, decorations, or details. Use small, subtle light gray text at low opacity, spaced in multiple background-only positions like a quiet diagonal watermark pattern. The watermark must remain premium, unobtrusive, and clearly secondary to the product.\n\n"
            "Do not:\n"
            "Do not create a lifestyle scene. Do not add models, hands, props, labels, badges, extra text other than the subtle repeated EasyGros watermark, packaging, extra products, invented variants, duplicated variants, or changed colors. Do not remove, blur, repaint, or invent on-product markings; preserve only the markings that genuinely exist on the source product. Do not choose only one variant. Do not merge variants together. Do not restyle the product. Do not place watermark text on top of any product or product shadow.\n\n"
            "Output:\n"
            "A sharp, photorealistic, marketplace-ready product photo with crisp edges, no halos or fringing, natural lighting, realistic shadows, subtle repeated EasyGros watermarks only in the empty background areas, and a clean Shopify-ready square crop."
        )
